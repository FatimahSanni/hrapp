class ExitInterviewsController < ApplicationController
  ...
  private
    ...
    def exit_interview_params
      params.require(:exit_interview).permit(:staff_id, :higher_pay, :better_benefits, :better_career, :life_balance, :career_change, :closer, :employee_conflict, :manager_conflict, :family, :company_instability, :other, :note, :tag_list, :salary, :timely_wage, :benefit, :work_life_balance, :benefit_comment, :orientation, :positive_environment, :adequate_equipment, :get_on, :sufficient_staff, :efficient_company, :internal_commmunication, :no_bullying, :discrimination, :company_comment, :sufficient_knowledge, :experience, :open, :acknowledge_achievements, :recognise_contributions, :promote_development, :constructive_feedback, :clear_communication, :professional_relationship, :supervisor_comment, :equal_treatment, :discuss_issues, :encourage_feedback, :consistent_policies, :provide_recognition, :gave_development_opportunities, :gave_feedback, :clear_decision, :management_comment)
    end
end
