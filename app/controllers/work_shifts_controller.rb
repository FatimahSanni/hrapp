class WorkShiftsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @work_shift.save
        format.html { redirect_to work_shifts_url, notice: 'Work shift was successfully created.' }
        format.json { render :index, status: :created, location: work_shifts_url }
      else
  ...
  def update
    respond_to do |format|
      if @work_shift.update(work_shift_params)
        format.html { redirect_to work_shifts_url, notice: 'Work shift was successfully updated.' }
        format.json { render :index, status: :ok, location: work_shifts_url }
      else
