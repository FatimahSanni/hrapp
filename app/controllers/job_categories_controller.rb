  ...
  def create
    ...
    respond_to do |format|
      if @job_category.save
        format.html { redirect_to job_categories_url, notice: 'Job category was successfully created.' }
        format.json { render :index, status: :created, location: job_categories_url }
      else
  ...
  def update
    respond_to do |format|
      if @job_category.update(job_category_params)
        format.html { redirect_to job_categories_url, notice: 'Job category was successfully updated.' }
        format.json { render :index, status: :ok, location: job_categories_url }
      else
